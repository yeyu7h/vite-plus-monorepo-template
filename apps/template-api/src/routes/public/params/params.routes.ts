...
export const list = createRoute({
  ...
  path: routePrefix,
  responses: {
    [HttpStatusCodes.OK]: jsonContent(RefineResultSchema(paramListResponseSchema), '查询成功'),
  },
})
...
export const getByKey = createRoute({
  ...
  responses: {
    [HttpStatusCodes.OK]: jsonContent(RefineResultSchema(paramResponseSchema), '查询成功'),
