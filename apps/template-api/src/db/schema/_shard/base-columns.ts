...
export const baseColumns = {
  // Below pg18 use .$defaultFn(() => uuidV7()) (requires uuid lib), pg18+ use .default(sql`uuidv7()`)
   ...
   * Creation time / 创建时间
   */
  createdAt: timestamp({ mode: 'string', precision: 0 }).$defaultFn(() => format(new Date(), 'yyyy-MM-dd HH:mm:ss')),
