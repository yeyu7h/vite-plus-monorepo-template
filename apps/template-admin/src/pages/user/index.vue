...
const columns: TableColumn<Payment>[] = [
  ...
  },
  {
    ...
    cell: ({ row }) => {
      ...
      return h(Badge, { class: 'capitalize', variant: 'subtle', color }, () => row.getValue('status'))
    },
  },
  {
    accessorKey: 'email',
    ...
    cell: ({ row }) => {
      const items: DropdownMenuItem[] = [
        ...
        },
        {
          ...
          onSelect() {
            toast.add({ title: 'Payment ID copied to clipboard!', color: 'success', icon: 'i-lucide-circle-check' })
          },
        },
        {
