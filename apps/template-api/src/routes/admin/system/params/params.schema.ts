...
/** Parameter key field / 参数键字段 */
export const paramKeyField = z
  .string()
  .min(1, '参数键不能为空')
  .max(128, '参数键最多128个字符')
...
/** Parameter base fields (shared) / 参数基础字段（共享） */
