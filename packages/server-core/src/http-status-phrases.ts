 ...
 */
export const EXPECTATION_FAILED = '期望失败'
/**
 ...
 * 请求因先前请求的失败而失败。
 */
export const FAILED_DEPENDENCY = '依赖失败'
/**
 ...
 */
export const GATEWAY_TIMEOUT = '网关超时'
/**
 ...
 */
export const HTTP_VERSION_NOT_SUPPORTED = 'HTTP版本不支持'
/**
 ...
 */
export const INSUFFICIENT_SPACE_ON_RESOURCE = '资源空间不足'
/**
 * Official docs @ https://tools.ietf.org/html/rfc2518#section-10.6
 *
 ...
 */
export const INSUFFICIENT_STORAGE = '存储空间不足'
/**
 ...
 */
export const LENGTH_REQUIRED = '需要内容长度'
/**
 ...
 */
export const METHOD_FAILURE = '方法失败'
/**
 ...
 */
export const METHOD_NOT_ALLOWED = '方法不允许'
/**
 ...
 */
export const MOVED_PERMANENTLY = '永久移动'
/**
 ...
 */
export const MOVED_TEMPORARILY = '临时移动'
/**
 ...
 */
export const MULTIPLE_CHOICES = '多重选择'
/**
 ...
 */
export const NETWORK_AUTHENTICATION_REQUIRED = '需要网络身份验证'
/**
 ...
 */
export const NON_AUTHORITATIVE_INFORMATION = '非权威信息'
/**
 ...
 */
export const NOT_ACCEPTABLE = '不可接受'
/**
 ...
 */
export const NOT_IMPLEMENTED = '未实现'
/**
 ...
 */
export const PARTIAL_CONTENT = '部分内容'
/**
 ...
 */
export const PAYMENT_REQUIRED = '需要付款'
/**
 ...
 */
export const PERMANENT_REDIRECT = '永久重定向'
/**
 ...
 */
export const PRECONDITION_FAILED = '先决条件失败'
/**
 ...
 */
export const PRECONDITION_REQUIRED = '需要先决条件'
/**
 ...
 */
export const UPGRADE_REQUIRED = '需要升级'
/**
 ...
 */
export const PROXY_AUTHENTICATION_REQUIRED = '需要代理身份验证'
/**
 ...
 */
export const REQUEST_HEADER_FIELDS_TOO_LARGE = '请求头字段过大'
/**
 ...
 */
export const REQUEST_TIMEOUT = '请求超时'
/**
 ...
 */
export const REQUEST_TOO_LONG = '请求实体过大'
/**
 ...
 */
export const REQUEST_URI_TOO_LONG = '请求URI过长'
/**
 ...
 */
export const REQUESTED_RANGE_NOT_SATISFIABLE = '请求范围不满足'
/**
 ...
 */
export const RESET_CONTENT = '重置内容'
/**
 ...
 */
export const SERVICE_UNAVAILABLE = '服务不可用'
/**
 ...
 */
export const SWITCHING_PROTOCOLS = '切换协议'
/**
 ...
 */
export const TEMPORARY_REDIRECT = '临时重定向'
/**
 ...
 */
export const TOO_MANY_REQUESTS = '请求过多'
/**
 ...
 */
export const UNAVAILABLE_FOR_LEGAL_REASONS = '因法律原因不可用'
/**
 ...
 * 请求格式正确，但由于语义错误而无法遵循。
 */
export const UNPROCESSABLE_ENTITY = '无法处理的实体'
/**
 ...
 */
export const UNSUPPORTED_MEDIA_TYPE = '不支持的媒体类型'
/**
 * @deprecated
 ...
 */
export const MISDIRECTED_REQUEST = '错误定向请求'
